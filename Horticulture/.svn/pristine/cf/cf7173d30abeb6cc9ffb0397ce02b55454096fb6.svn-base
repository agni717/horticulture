...
<div class=" page-body-wrapper">
   <div class="container">
      ...
      <div class="row mt-1">
         <div class="col-lg-9 mx-auto title-size">
            <h1>Schemes List</h1>
         </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-6 grid-margin my-2">          
          <div class="box mb-3 px-3">
            <h2>Scheme Description Name 1</h2>
            ...
            <!-- <ul>
              ...
              foreach($schemes as $row)
              {
                 ...
                 /*$sch_start_date=$row->created;
                 $sch_end_date=$row->modified;
                 $today= date("Y-m-d");*/
              ...
              <li>
                 <i class="fa fa-arrow-circle-o-right" aria-hidden="true"><?=$c?></i> 
                 <a href="<?php echo base_url('user/initiate/'.$row->id);?>">
                    <b> <?php echo $row->scheme_name;?>:</b> 
                    <?php echo $row->details;?>
                    <?php echo 'Apply on:' .$row->created;?>-<?php echo $row->modified;?>  
                 </a>
                 <?php
                  }
                  $c++;
        ...
        <div class="col-lg-3 grid-margin">
          <div class="btns">
             <a href="#" class="btn btn-primary mb-2" type="submit">Interested Applicant may apply by clicking here</a>
             <a href="http://localhost:8082/horticulture_assemble/applicant/details" class="btn btn-success" type="submit">Existing user can Login by Clicking here</a>
          </div>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-6 grid-margin my-2">          
          <div class="box mb-3 px-3">
            <h2>Scheme Description Name 2</h2>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>            
          </div>
        </div>
        <div class="col-lg-3 grid-margin">
