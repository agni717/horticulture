         ...
         <div class="container-fluid">
            ...
            <div class="row">
               <div class="col-lg-10 grid-margin mx-auto">
                  <div class="card">
                     <div class="card-body">
                        <?php echo form_open('admin/district_dashboard/citizen_form_details/'.$application_id,array('name'=>'frmDist','id'=>'frmDist','method'=>'post','onsubmit'=>'return lfn_chkRemDist();')); ?>
                       ...
                       <form id="frmAppRej" name="frmAppRej">
                          ...
                          <div class="remarks_container">
                            <div class="form-group form-row" id="dist_apprv">
                              ...
                              <div class="col-lg-6 mt-0">
                                <h4 class="py-2 text-primary">District approval amount: <?php echo $app_data->dist_approval_amount; ?></h4>
                              </div>
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-4">
                                <label class="col-form-label" id="remarks_label">HQ Approval Amount:</label>
                                <input type="text" class="form-control" name="hq_approval" id="hq_approval" />
                              </div>                     
                            </div>
...
<script type="text/javascript">
  ...
  function lfn_app_rej_rev(act)
  {
   ...
   $('#btn_submit').on("click",function(event){
	  ...
	  var hq_approval = $('#hq_approval').val().trim();
	  ...
	  if(cnt_status == "Approve"){
		  ...
		  if(hq_approval == ""){
		   	 $("#hq_approval").focus();
			 $('#ar_msg_cont').show().html('HQ approval amount cannot be blank');
			 setTimeout(function(){$('#ar_msg_cont').hide()}, 4000);
			 error_flag = true;
			 return false;
		  }
		  if(!hq_approval.match(onlynumerics)){
				 $("#hq_approval").focus();
				 $('#ar_msg_cont').show().html('HQ approval amount should number only');
				 setTimeout(function(){$('#ar_msg_cont').hide()}, 4000);
				 error_flag = true;
				 return false;
		  }
      ...
      if(error_flag == false){
         $.ajax({
                url: '<?php echo base_url('admin/hq_dashboard/ajax_app_approve_by_district') ?>',
                type: 'POST',
                data: formData, 
                contentType: false,
                cache: false,
