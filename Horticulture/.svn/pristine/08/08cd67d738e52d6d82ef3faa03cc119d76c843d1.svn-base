    ...
    <div class="container-fluid">
      ...
      <div class="row">
            ...
            <div class="col-lg-8 grid-margin  m-auto">
             ...
             <h4 class="card-title mt-5">Edit Scheme</h4>
              <div class="card">
                <div class="card-body">
                <!--  <form class="form-sample"> -->
                   <?php echo form_open('admin/headquater/edit_scheme/'.$scheme_data[0]->id); ?>
                    <?php if(isset($error)) :?>
                    ...
                    <div class="row mb-2">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $scheme_data[0]->scheme_name; ?>" />
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="date" class="form-control" name="created" id="created" value="<?php echo $scheme_data[0]->created; ?>"/>
                    ...
                    <div class="row mb-2">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="date" class="form-control"  name="modified" id="modified" value="<?php echo $scheme_data[0]->modified; ?>" />
					...
					<div class="row mb-2">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control text_editor" id="exampleFormControlTextarea1" name="details" rows="4"><?php echo $scheme_data[0]->details;?></textarea>
                    ...
                    <a class="btn btn-success" href="<?php echo base_url('admin/headquater/scheme_list')?>" role="button">Go to list</a>
