...
class Application_Controller extends MY_Controller {
	...
	function __construct() {		
        ...
        if (in_array(uri_string(), $exception_uris) == FALSE) {
            ...
            if ($this->application_m->member_loggedin() == FALSE) {
