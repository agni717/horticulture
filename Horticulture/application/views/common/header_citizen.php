...
<html lang="en">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/vendors/typicons/typicons.css">
      ...
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	   <link rel="stylesheet" href="<?php echo base_url();?>assets/css/vertical-layout-light/select2.min.css">
   ...
   <header>
         ...
         <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item nav-date dropdown">
				<a class="nav-link" href="<?php echo base_url('userset/applicant_reg_detailsets') ?>">
               ...
               <li class="nav-item nav-date dropdown">
                  <a class="nav-link d-flex justify-content-center align-items-center" href="<?php echo base_url('userset/logout');?>">
      ...
      <nav class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0">
         <ul class="nav">
           ...
           <!--  <li class="nav-item">
               <a href="applicant-list-for-citizen.php"class="nav-link">
