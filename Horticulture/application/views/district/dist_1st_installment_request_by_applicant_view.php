                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              ...
                              {
                                 if($app_data->apply_for_1st_installment_release==1) { ?>
								...
								<form id="frmAppRej" name="frmAppRej">
								  ...
								  <div class="remarks_container">
									<div class="form-group form-row" id="dist_apprv">
									  ...
									  <div class="col-lg-4">
										<label class="col-form-label" id="remarks_label">1st installment approved by district:</label>
										<input type="text" class="form-control" name="dist_1st_release_approval" id="dist_1st_release_approval" value="<?php echo ($app_data->hq_approval_amount/2) ?>" />
									  </div>                     
									</div>
...
<script type="text/javascript">
  ...
  function lfn_app_rej_rev(act)
  {
   ...
   $('#btn_submit').on("click",function(event){
      ...
      var dist_1st_release_approval = $('#dist_1st_release_approval').val().trim();
	  ...
	  if(cnt_status == "Approve"){
		  ...
		  if(dist_1st_release_approval == ""){
		   	 $("#dist_1st_release_approval").focus();
			 $('#ar_msg_cont').show().html('District release approval amount cannot be blank');
			 setTimeout(function(){$('#ar_msg_cont').hide()}, 4000);
			 error_flag = true;
			 return false;
		  }
		  if(!dist_1st_release_approval.match(onlynumerics)){
				 $("#dist_1st_release_approval").focus();
				 $('#ar_msg_cont').show().html('District release approval amount should number only');
				 setTimeout(function(){$('#ar_msg_cont').hide()}, 4000);
				 error_flag = true;
				 return false;
		  }
      ...
      if(error_flag == false){
         //alert(123);
         $.ajax({
                url: '<?php echo base_url('admin/district_dashboard/submit_approve_1st_installment_request_by_applicant') ?>',
                type: 'POST',
                data: formData, 
                contentType: false,
                cache: false,
