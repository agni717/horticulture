               ...
               <div class="col-lg-11 grid-margin mx-auto">
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        echo form_open_multipart('user/project',array('onsubmit'=>'return submitProject();','id'=>"addFrm")); 
                              ...
                              <div class="form-row">
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    if(set_value('proj_district') !=''){
                                     ...
                                     ?>
                                       <?php } ?>
                                    <select class="form-control" name="proj_district" id="district_code" onchange="lfn_SetSubDivision(this.value);">
                                       <option value="">---Select---</option>
                                       
                                       <?php foreach ($district_data as $row) { ?> 
                                    <option value="<?php echo $row->district_code  ;?>" <?php if($row->district_code==$proj_district){ echo 'selected';}?>><?php echo $row->district_name ;?></option>
                            ...
                            <?php } ?> 
                                 ...
                                 <!--<div class="col-lg-3">
                                   ...
                                   // }
                                    // ?>
                                    //<?php// } ?>
                                    <input type="text" class="form-control"  name="proj_sub_division" id="proj_sub_division" value="<?php////$proj_sub_division;//?>"/>
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    if(set_value('Sub_Division') !=''){
                                       $user_Sub_Division = set_value('Sub_Division');
                                    }*/
                                     ?>
                                    <!-- <input type="text" class="form-control"  name="Sub_Division" value="<?php //echo $user_Sub_Division; ?>"   placeholder="" /> -->
                                    <?php
                                    $proj_sub_division ='';
                                    if(!empty($project_data)){
                                    if($project_data->proj_sub_division !=''){
                                    ...
                                    <select class="form-control" name="proj_sub_division"  id="Sub_Division" <?php if($proj_sub_division =''){ echo 'selected';}?>  onchange="lfn_SetBlock(this.value);" required>
                                       <option value="">---Select---</option>
                              ...
                              <div class="form-row">
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    if(set_value('proj_block') !=''){
                                     ...
                                     ?>
                                    <?php } ?>
                                    <select class="form-control" name="proj_block" id="Block">
                                       <option value="">---Select---</option>
                           ...
                           <div class="form-group">
                              <div class="form-row">
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    <option value="<?php echo $row->bank_id  ;?>" <?php if($row->bank_id==$proj_bank_name){ echo 'selected';}?>><?php echo $row->bank_name ;?></option>
                            ...
                            <?php } ?> 
                                 ...
                                 <div class="col-lg-3">
                                    ...
                                    <!-- <input type="text" class="form-control" name="proj_branch" id="proj_branch" value="<?=$proj_branch;?>" /> -->
                                     ...
                                     <option value="<?php echo $row->branch_id  ;?>" <?php if($row->branch_id==$proj_branch){ echo 'selected';}?>><?php echo $row->branch_name ;?></option>
    ...
    function lfn_SetSubDivision(district_code)
      {
         //alert(district_id);
         $.ajax({
               url: "<?php echo base_url('applicant/ajax_get_subdivision') ?>",
               type: 'POST',
      ...
      {
         $.ajax({
            url: "<?php echo base_url('applicant/ajax_get_block') ?>",
            type: 'POST',
